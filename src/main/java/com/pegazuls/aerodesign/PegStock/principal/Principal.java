...
public class Principal {
    ...
    public void teste() {
        ...
        Material updatedMaterial = materialService.findById(material1.getCod());
        System.out.println("Updated material: " + updatedMaterial);
        ...
        System.out.println("Most available material: " + mostAvailableMaterial);

        // Find the nearest expiration material
        Material nearestExpirationMaterial = materialService.nearestExpiration();
        System.out.println("Nearest expiration material: " + nearestExpirationMaterial);
